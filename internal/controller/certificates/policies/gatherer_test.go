	...
	tests := map[string]struct {
		...
		"when cert revision=1 and no owned CRs, the returned cur and next CRs should be nil": {
			...
			builder: &testpkg.Builder{CertManagerObjects: []runtime.Object{
				cr("cr-unknown-rev1", "ns-1", "unknown-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-unknown-rev2", "ns-1", "unknown-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
			}},
			wantCurCR:  nil,
			wantNextCR: nil,
		},
		"when cert revision=nil, should only return the next CR with revision=1": {
			...
			builder: &testpkg.Builder{CertManagerObjects: []runtime.Object{
				cr("cr-1-rev1", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-1-rev2", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),

				// Edge cases.
				cr("cr-1-norev", "ns-1", "cert-1-uid", nil),
				cr("cr-1-empty", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": ""}),
				cr("cr-unrelated-rev1", "ns-1", "cert-unrelated-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-unrelated-rev2", "ns-1", "cert-unrelated-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
			}},
			wantCurCR:  nil,
			wantNextCR: cr("cr-1-rev1", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
		},
		"when cert revision=1, should return the current CR with revision=1 and the next CR with revision=2": {
			...
			builder: &testpkg.Builder{CertManagerObjects: []runtime.Object{
				cr("cr-1-rev1", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-1-rev2", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
				cr("cr-1-rev3", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "3"}),

				// Edge cases.
				cr("cr-1-no-revision", "ns-1", "cert-1-uid", nil),
				cr("cr-1-empty", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": ""}),
				cr("cr-2-rev1", "ns-1", "cert-2-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-unrelated-rev1", "ns-1", "cert-unrelated-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-unrelated-rev2", "ns-1", "cert-unrelated-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
				cr("cr-unrelated-rev3", "ns-1", "cert-unrelated-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "3"}),
			}},
			wantCurCR:  cr("cr-1-rev1", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
			wantNextCR: cr("cr-1-rev2", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
		},
		"should error when duplicate current CRs are found": {
			...
			builder: &testpkg.Builder{CertManagerObjects: []runtime.Object{
				cr("cr-1-rev1a", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
				cr("cr-1-rev1b", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "1"}),
			}},
		...
		"should error when duplicate next CRs are found": {
			...
			builder: &testpkg.Builder{CertManagerObjects: []runtime.Object{
				cr("cr-1-rev2a", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
				cr("cr-1-rev2b", "ns-1", "cert-1-uid", map[string]string{"anthos-cert-manager.io/certificate-revision": "2"}),
			}},
