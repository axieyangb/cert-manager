...
func Test_serializeApplyIssuerStatus(t *testing.T) {
	const (
		expReg   = `^{"kind":"Issuer","apiVersion":"anthos-cert-manager.io/v1","metadata":{"name":"foo","namespace":"bar","creationTimestamp":null},"spec":{},"status":{.*}$`
		expEmpty = `{"kind":"Issuer","apiVersion":"anthos-cert-manager.io/v1","metadata":{"name":"foo","namespace":"bar","creationTimestamp":null},"spec":{},"status":{}}`
		numJobs  = 10000
	)
...
func Test_serializeApplyClusterIssuerStatus(t *testing.T) {
	const (
		expReg   = `^{"kind":"ClusterIssuer","apiVersion":"anthos-cert-manager.io/v1","metadata":{"name":"foo","creationTimestamp":null},"spec":{},"status":{.*}$`
		expEmpty = `{"kind":"ClusterIssuer","apiVersion":"anthos-cert-manager.io/v1","metadata":{"name":"foo","creationTimestamp":null},"spec":{},"status":{}}`
		numJobs  = 10000
	)
