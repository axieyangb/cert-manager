...
const (
	...
	CertificateSigningRequestDurationAnnotationKey = "experimental.anthos-cert-manager.io/request-duration"
	...
	CertificateSigningRequestIsCAAnnotationKey = "experimental.anthos-cert-manager.io/request-is-ca"
	...
	// the experimental.anthos-cert-manager.io/request-duration annotation. This
...
const (
	...
	CertificateSigningRequestPrivateKeyAnnotationKey = "experimental.anthos-cert-manager.io/private-key-secret-name"
)
...
const (
	...
	CertificateSigningRequestVenafiCustomFieldsAnnotationKey = "venafi.experimental.anthos-cert-manager.io/custom-fields"
	...
	CertificateSigningRequestVenafiPickupIDAnnotationKey = "venafi.experimental.anthos-cert-manager.io/pickup-id"
)
