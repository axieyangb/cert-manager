...
const (
	...
	DomainLabelKey = "acme.anthos-cert-manager.io/http-domain"
	...
	TokenLabelKey = "acme.anthos-cert-manager.io/http-token"
	...
	SolverIdentificationLabelKey = "acme.anthos-cert-manager.io/http01-solver"
)
